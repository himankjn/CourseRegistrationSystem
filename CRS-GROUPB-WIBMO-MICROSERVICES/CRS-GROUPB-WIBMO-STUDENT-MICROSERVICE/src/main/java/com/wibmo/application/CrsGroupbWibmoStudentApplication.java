...
public class CrsGroupbWibmoStudentApplication {

	public static void main(String[] args) {
		SpringApplication.run(CrsGroupbWibmoStudentApplication .class, args);
	}
	@Bean
    ...
    private SecurityContext securityContext() {
        return SecurityContext.builder().securityReferences(List.of(basicAuthReference(), bearerAuthReference())).forPaths(PathSelectors.ant("/student/**")).build();
    }
